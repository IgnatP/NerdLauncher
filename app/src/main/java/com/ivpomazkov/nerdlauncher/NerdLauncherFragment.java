package com.ivpomazkov.nerdlauncher;
...
/**
 * Created by ivpomazkov on 19.05.2016.
 */
public class NerdLauncherFragment extends Fragment {
    ...
    implements  View.OnClickListener{
        ...
        public ActivityHolder(View itemView){
            super(itemView);
            mNameTextView = (TextView) itemView.findViewById(R.id.item_textView);
        ...
        public void bindActivity(ResolveInfo resolveInfo){
            ...
            Bitmap icon = null;
            if (bd.getBitmap() != null) icon = bd.getBitmap();
    ...
    private  class ActivityAdapter extends RecyclerView.Adapter<ActivityHolder>{
        ...
        public ActivityHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = inflater.inflate(R.layout.element_view,parent,false);
